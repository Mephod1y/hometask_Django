...
class AuthorUpdateView(UpdateView):
    ...
    template_name = 'quotesapp/edit_author.html'
...
class QuoteUpdateView(UpdateView):
    ...
    template_name = 'quotesapp/edit_quote.html'
...
class QuoteRemoveView(DeleteView):
    model = Quote
    success_url = reverse_lazy('quotesapp:index')
...
class QuoteView(View):
    quotes_per_page = 10
    template_get = 'quotesapp/quotes.html'
    template_add = 'quotesapp/add_quote.html'
...
class AuthorView(View):
    template_get = 'quotesapp/author.html'
    template_add = 'quotesapp/add_author.html'
...
class TagView(View):
    template_name = 'quotesapp/add_tags.html'
    form_class = TagForm
    model = Tag
